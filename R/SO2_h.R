#' SO2_flux_h - Calculates hourly deposition of SO2 on vegetation
...
#' @return Hourly data of SO2 deposited (g m-2 yr-1)
#' @export
#'
#' @examples
#'
#' data(Bizkaia_data)
#' SO2_flux_h(x = Bizkaia_data)
#'
SO2_flux_h <- function(x){
  db <- x
  ...
  myresults <- data.frame(Dates=db$Dates, Flux_SO2_hourly=Flux_SO2_hourly)
  return(myresults)
}
