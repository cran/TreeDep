...
Dep_SO2 <- function(x, z_0 = 1){
  ...
  Flux_SO2_hourly0 <- db$SO2/1000000*Dep_vel_SO2(db, z_0 = z_0)[,"Depos_vel"]*t_s*No_rain_event*LAI_Total_scaled # g/m2/h = g/m3 * m/s * s/h * unitless * unitless
