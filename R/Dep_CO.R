...
Dep_CO <- function(x, z_0 = 1){
  ...
  Flux_CO_hourly0 <- db$CO/1000000*Dep_vel_CO(db, z_0 = z_0)[,"Depos_vel"]*t_s*No_rain_event*LAI_Total_scaled # g/m2/h = g/m3 * m/s * s/h * unitless * unitless
