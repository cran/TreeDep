...
Dep_NO2 <- function(x){
  ...
  Flux_NO2_hourly0 <- db$NO2/1000000*Dep_vel_NO2(db)[,"Depos_vel"]*t_s*No_rain_event*LAI_Total_scaled # g/m2/h = g/m3 * m/s * s/h * unitless * unitless
