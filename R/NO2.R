#' NO2_flux - Calculates annual deposition of NO2 on vegetation
...
#' @return Annual value of NO2 deposited (g m-2 yr-1)
#' @export
#'
#' @examples
#'
#' data(Bizkaia_data)
#' NO2_flux(x = Bizkaia_data)
#'
NO2_flux <- function(x){
  db <- x
