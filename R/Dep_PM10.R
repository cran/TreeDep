...
#' @return Hourly data of deposition of PM10 on vegetation (g m-2 h-1)
#' @export
#'
#' @examples
#'
...
Dep_PM10 <- function(x, z_0 = 1){
  ...
  Flux_PM10_hourly0 <- db$PM10/1000000*Dep_vel_PM10(db, z_0 = z_0)[,"Depos_vel"]*t_s*No_rain_event*LAI_Total_scaled # g/m2/h = g/m3 * m/s * s/h * unitless * unitless
  Flux_PM10_hourly <- cbind.data.frame(Dates = db$Dates, Depos_PM10 = Flux_PM10_hourly0)
  return(Flux_PM10_hourly)
}
