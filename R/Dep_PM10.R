...
Dep_PM10 <- function(x){
  ...
  Flux_PM10_hourly0 <- db$PM10/1000000*Dep_vel_PM10(db)[,"Depos_vel"]*t_s*No_rain_event*LAI_Total_scaled # g/m2/h = g/m3 * m/s * s/h * unitless * unitless
